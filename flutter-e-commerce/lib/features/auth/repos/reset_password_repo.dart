...
class ResetPasswordRepoImp extends ResetPasswordRepo{
  ...
  @override
  Future<Either<Failure, Map<String, dynamic>>> reset(Map<String, dynamic> data) async{
     return await apiService.ajax(requestType: RequestType.post, endPoint: ApiLinks.resetPassword, data: data);
  }
}