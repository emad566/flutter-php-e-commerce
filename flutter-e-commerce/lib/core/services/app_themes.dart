...
abstract class AppThemes {
  static  ThemeData get lightThem => ThemeData(
    ...
    textTheme: ChangeLangController().langStr == 'ar'?
              GoogleFonts.cairoTextTheme(_lightTextTheme) : GoogleFonts.playfairDisplayTextTheme(_lightTextTheme),
  );

  static  ThemeData get darkThem => ThemeData(
    useMaterial3: true,
    textTheme: ChangeLangController().langStr == 'ar'?
    GoogleFonts.cairoTextTheme(_darkTextTheme) : GoogleFonts.playfairDisplayTextTheme(_darkTextTheme),
  );
